...
plot_loss(history, "Model Loss Function")
...
plt.legend()
plt.grid(True)
accuracyPATH=os.path.join(ResultPATH, "Model Accuracy.png")
...
plt.legend()
plt.grid(True)
lossPATH=os.path.join(ResultPATH, "Model Loss Function.png")
