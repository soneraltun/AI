# -*- coding: utf-8 -*-
"""
Created on Wed Dec 18 09:26:13 2024
...
from VGG16_Model import VGG_model,GetModel_BatchSize,GetModel_Epochs,GetModel_l_rate,GetModel_num_classes
...
plot_loss(history, "Original Model Loss Function")
...
save_model(model,'VGG16_ILD_Original')
...
plt.legend()
plt.grid(True)
accuracyPATH=os.path.join(ResultPATH, "Original Model Accuracy.png")
...
plt.legend()
plt.grid(True)
lossPATH=os.path.join(ResultPATH, "Original Model Loss Function.png")
